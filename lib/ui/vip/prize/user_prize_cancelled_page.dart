...
// ------------------------------------------------------
// author：suxing
// date  ：2021/1/21 下午7:27
// usage ：会员悬赏帖已取消订单详情
// ------------------------------------------------------

class UserPrizeCancelledPage extends StatefulWidget {
  final String postId;

  UserPrizeCancelledPage({this.postId, Key key}) : super(key: key);

  @override
  _UserPrizeCancelledPageState createState() => _UserPrizeCancelledPageState();
}

class _UserPrizeCancelledPageState extends State<UserPrizeCancelledPage>
    with AutomaticKeepAliveClientMixin {
  var _future;
  BBSPrize _bbsPrize; // 悬赏帖已取消详情
  ...
  _fetch() async {
    try {
      ...
      if (res != null) {
        _bbsPrize = res;
        Log.info("当前悬赏帖已取消详情：${_bbsPrize.toJson()}");
        setState(() {});
      }
    } catch (e) {
      Log.error("查询悬赏帖已取消详情出现异常：$e");
    }
  }
