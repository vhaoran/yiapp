...
// ------------------------------------------------------
// author：suxing
// date  ：2021/2/1 上午9:36
// usage ：会员已付款商城订单
// ------------------------------------------------------

class UserMallPaidPage extends StatefulWidget {
  UserMallPaidPage({Key key}) : super(key: key);

  @override
  _UserMallPaidPageState createState() => _UserMallPaidPageState();
}

class _UserMallPaidPageState extends State<UserMallPaidPage> {
  var _future;
  int _page_no = 0;
  int _rowsCount = 0;
