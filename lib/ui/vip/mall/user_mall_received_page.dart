...
// ------------------------------------------------------
// author：suxing
// date  ：2021/2/1 上午9:40
// usage ：会员已收货商城订单
// ------------------------------------------------------

class UserMallReceivedPage extends StatefulWidget {
  UserMallReceivedPage({Key key}) : super(key: key);

  @override
  _UserMallReceivedPageState createState() => _UserMallReceivedPageState();
}

class _UserMallReceivedPageState extends State<UserMallReceivedPage> {
  var _future;
  int _page_no = 0;
  int _rows_count = 0;
