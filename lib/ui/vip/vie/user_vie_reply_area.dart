...
// ------------------------------------------------------
// author：suxing
// date  ：2021/1/22 下午2:36
// usage ：会员闪断帖评论区
// ------------------------------------------------------

class UserVieReplyArea extends StatefulWidget {
  final BBSVie vie;

  UserVieReplyArea({this.vie, Key key}) : super(key: key);

  @override
  _UserVieReplyAreaState createState() => _UserVieReplyAreaState();
}

class _UserVieReplyAreaState extends State<UserVieReplyArea> {
  @override
