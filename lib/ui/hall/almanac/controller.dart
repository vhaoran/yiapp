...
class CalendarController {
  ...
  CalendarController(
      {int selectMode = CalendarConst.single_mode,
      int mode = CalendarConst.only_month,
      int minYear = 1971,
      int maxYear = 2055,
      int minYearMonth = 1,
      int maxYearMonth = 12,
    ...
    if (mode != CalendarConst.only_week) {
    ...
    if (mode != CalendarConst.only_month) {
      //计算一共多少周
