...
class ApiYiOrder {
  ...
  static refundOrderPage(Map<String, dynamic> pb) async {
    ...
    return await ApiBase.postPage(url, pb, (m) => RefundRes.fromJson(m));
  }
  ...
  /// 投诉单get-适用于状态为0的数据
  static Future<RefundRes> refundOrderGet(String id) async {
    var url = pre + "RefundOrderGet";
    var data = {"id": id};
    return await ApiBase.postObj(url, data, (m) => RefundRes.fromJson(m));
  }

  /// 投诉单历史get-适用于已完成数据
  static Future<RefundRes> refundOrderHisGet(String id) async {
