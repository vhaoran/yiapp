...
// usage ：《用户服务协议和隐私政策》本地数据
// ------------------------------------------------------

const String agreeHtml = """
<div>
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;《用户服务协议和隐私政策》（以下简称“协议”）及其条款，系确立您与河南微聊信息技术有限公司之间就下载、安装及使用其旗下软件“鸿运来”（以下简称“本软件”或“鸿运来”）所订立的、描述您与本软件之间权利义务的协议。
    </p>
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在注册前请务必认真阅读本协议的内容、充分理解各条款内容，如有异议，您可选择退出本软件。一旦您确认本用户注册协议后，本协议即在您和本软件之间产生法律效力，意味着您完全同意并接受协议的全部条款。请您审慎阅读并选择接受或不接受本协议（未成年人应在法定监护人陪同下阅读）。
    </p>
    <p>
      <strong>一.用户使用：</strong>
    </p>
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. 用户按照页面给予的提示完成全部注册步骤后，即成为‘鸿运来’的用户，用户应自行保管账号及密码，并准确、安全地使用其账号及密码。本软件可通过用户自行设定，向用户提供个性化的信息服务。
    </p>
    <p>
    ...
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 同时，社区版块发起者、管理者应当履行与本协议权利、法律法规相适应的义务，对违反法律规定和协议约定、履行责任义务不到位的服务提供者应当依法依约限制（更改或删除相关侵权信息、暂停使用）或取消其管理权限，直至封禁或者关闭有关账号、版块。
    </p>
    <p>
    ...
    <p>
     ...
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 11. 平台内的服务工作者应尽量促进来访者的成长、自强自立；应避免负面结论而对用户造成消极的暗示，或使用户在其未来的生活中对服务工作者产生依赖。
    </p>
    <p>
      <strong>二.隐私政策：</strong>
    </p>
    <p>
    ...
    <p>
     ...
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 3. 麦克风权限、蓝牙权限、摄像头权限：主要用户收听或使用语音服务，认证过程中的面部识别。
    </p>
    <p>
    ...
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2. 我们将以国家安全标准和法律法规的规定收集、使用、存储和传输用户信息，并通过用户协议和隐私政策告知您相关信息的使用目的和范围。同时，我们会对个人信息进行加密技术，以确保数据的保密性与安全性。
    </p>
    <p>
    ...
    <p>
     ...
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; A. 除法律法规规定外，您有权随时访问和更正您的个人信息，具体包括：您可通过【我的】 ，访问或者修改您的邮箱信息、密码、用户名；
    </p>
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2. 删除您的个人信息
    </p>
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. 您可通过【我的 → 关注】，取消您的关注记录； 您可通过【我的 →设置】，取消运势提醒； 您可通过【我的 →设置】，取消私信开关。
    </p>
    ...
    <p>
     ...
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1. 本软件是由河南微聊信息技术有限公司开发。本软件的一切知识产权，以及与软件相关的所有信息内容，包括但不限于：文字表述及其组合、图标、图饰、图像、图表、色彩、界面设计、版面框架、有关数据、附加程序、印刷材料或电子文档等均归本软件所有，受著作权法和国际著作权条约以及其他知识产权法律法规的保护。
    </p>
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2. 未经本软件书面同意，用户不得为任何营利性或非营利性的目的自行实施、利用、转让或许可任何三方实施、利用、转让上述知识产权。出现上述未经许可之行为时，本软件保留追究相关责任人法律责任之权利。
    </p>
    <p>
      <strong>六.修改与解释权：</strong>
    </p>
     <p>
    ...
    <p>
     ...
     <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 3.与本协议、使用本软件发生的任何争议或纠纷，双方应尽量友好协商解决；协商不成时，任何一方均有权将纠纷交由河南省郑州市高新区人民法院管辖。 
    </p>
     <p>
